...
where :
 ...
 --host generate report only about the host
 --domain generate report only about the domain
 --ipconfig generate report only about the IP addresses
 --os generate report only about the OS
 --cpu generate report only about the host
 --memory generate report only about the system memory
 --disk generate report only about the system disk space utilization
 --printer generate report only about the printers attached to the system"
}
